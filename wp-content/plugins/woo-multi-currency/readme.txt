...
== Screenshots ==
1. Currencies bar on the right
2. Currency selector on single product page
...
- Updated: Compatibility with version WC 10.6
...
/*2.2.10 - 2026.01.20*/
- Updated: New register Elementor widget hook
- Updated: Compatibility with WP 6.9 and WC 10.4
